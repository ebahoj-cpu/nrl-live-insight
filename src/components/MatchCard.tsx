  ...
  return (
    ...
    >
      ...
      <div className="mt-5 pt-4 border-t border-border flex items-center justify-between gap-3 text-xs">
        ...
        <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-accent !text-black font-bold text-xs tracking-wide group-hover:gap-2.5 transition-all shrink-0 shadow-[0_4px_14px_-4px_color-mix(in_oklab,var(--accent)_60%,transparent)]">
