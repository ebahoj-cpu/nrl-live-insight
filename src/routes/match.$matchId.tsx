...
import {
  ...
  Receipt, X, Newspaper, History, ScrollText, Swords,
} from "lucide-react";
import {
  ...
  return (
    <div className="pt-6">
      ...
      <div className="mt-6">
        ...
        {tab === "stats" && <StatsTab home={details.homeTeam} away={details.awayTeam} homeRow={homeRow} awayRow={awayRow} statGroups={details.statGroups} recentRecaps={recentRecaps} recentH2H={recentH2H ?? []} />}
        {tab === "insights" && (
          <InsightsTab
            matchId={matchId}
            insights={insights}
...
function LineupTab({ home, away, officials, teamNews }: { home: any; away: any; officials: { position: string; firstName: string; lastName: string; headImage?: string }[]; teamNews?: { home: TeamNews; away: TeamNews } }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {view === "list" ? (
        /* List view: head-to-head with home and away players matched up
           side-by-side by position (like it used to be). */
...
function AnytimeOddsTag(_: { price: number | null }) {
  return null;
}
