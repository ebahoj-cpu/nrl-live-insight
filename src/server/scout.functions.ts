...
export const scoutChat = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }): Promise<{ reply: string }> => {
    ...
    const system = [
      ...
      "• Output 5–8 bullet points ONLY. Nothing else.",
      "• Max 20 words per bullet. No filler. No hedging. No journalism.",
      "• Each bullet = ONE idea with a clear EDGE or ADVANTAGE.",
      "• No introductions, no summaries, no closing lines, no disclaimers.",
      "• No paragraphs. No headings. Bullets only (use '- ').",
      "• Write like a sharp professional bettor, not an explainer.",
      "",
      "FOCUS AREAS (pick what fits the question):",
      "• Edge mismatches (left / right / middle)",
      "• Possession dominance & territory",
      "• Game script (early / middle / late)",
      "• Defensive weaknesses & fatigue windows",
      "• Try-scoring patterns & spine threats",
      "• Price/line value vs the SNAPSHOT data",
      "",
      "GOOD STYLE:",
      "- Left edge overload vs weak right defence",
      "- Late fatigue exposes middle → hooker try threat rises",
      "- Underdog at 2.40 + last5 3W → H2H value",
      "",
      "BAD STYLE (never do this):",
      "- 'Team A is likely to win because…'",
      "- 'This could be a close game…'",
      "- Anything vague, obvious, or padded.",
      "",
      "DATA RULES:",
      "• Quote exact prices/lines from SNAPSHOT when relevant.",
      "• If a fact is missing, skip it. Never invent.",
      "• 'Model estimate' = fallback price, not live book.",
      "",
      "=== SNAPSHOT ===",
      context,
      "=== END SNAPSHOT ===",
